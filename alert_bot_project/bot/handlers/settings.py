...
async def initiate_custom_trigger_prompt(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.answer(
        ...
        "⚠ <b>Важливо:</b> Моніторинг працює виключно по Одесі та Одеській області. Вводити інші міста України немає сенсу.\n\n"
        "💡 <b>Порада щодо введення:</b> вводьте <b>основу слова</b> без закінчення.\n"
        "Наприклад, замість «Малиновського» введіть <b>малиновск</b>, замість «Олександрівка» введіть <b>олександрівк</b>.\n"
