...
OUTSIDE_LOCS = {
    ...
    "belgorod": {
        "emoji": "🏰",
        "display": "Білгород-Дністровський",
...
KR_POTVORY = {
    ...
    "Ракети": [
        ...
        "ту95",
        "ту-22",
        "ту22",  # ✅ ФИКС: добавили баллистику и авиацию
    ],
    "Морські цілі": ["бэк", "мбэк", "катер", "морской дрон", "морський дрон"],
}
...
ALERT_SECOND = "⚠️ <b>Нагадування про попередній сигнал.</b> Перевірте поточний стан у офіційних джерелах."
ALERT_THIRD = "⚠️ <b>Повторне нагадування.</b> Оцініть актуальну обстановку за офіційними повідомленнями."
