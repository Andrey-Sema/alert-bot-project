...
ALERT_DELAY_2 = 300  # 5 хвилин між кожним наступним повторним сповіщенням

# Кількість повторів сигналу тривоги, доступна користувачу для вибору в меню налаштувань
REPEAT_COUNT_OPTIONS = (3, 5, 10, 20)
